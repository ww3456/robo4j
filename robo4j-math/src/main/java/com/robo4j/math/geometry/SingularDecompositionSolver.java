...
public class SingularDecompositionSolver {
    ...
    private final Matrix9d cachedU;
    private Matrix9d cachedUt;
    private final Matrix9d cachedV;


    public SingularDecompositionSolver(Matrix matrix) {

        double[][] A = matrix.getData();
        this.m = matrix.getDimension();
        ...
        while(true) {
            ...
            this.tol = max((double)this.m * this.singularValues[0] * 2.220446049250313E-16D, Math.sqrt(2.2250738585072014E-308D));
    ...
    public DecompositionSolver getSolver() {
        return new SingularDecompositionSolver.Solver(this.singularValues, this.getUT(), this.cachedV, this.getRank() == this.m, this.tol);
    }
    ...
    private static class Solver  implements DecompositionSolver {
        ...
        private Solver(double[] singularValues, Matrix9d uT, Matrix9d v, boolean nonSingular, double tol) {
